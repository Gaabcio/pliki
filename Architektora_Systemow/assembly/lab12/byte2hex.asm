...
;        esp -> [format][ret]
         ...
         lea edi, [edi + hex - format]  ; edi = edi + hex - format = hex
         ...
         cmp al, 10  ; al - 10       ; CF affected
         jb _09      ; jump if below ; jump if CF = 1
...
_09      add al, '0'
         ...
         cmp dl, 10 ; dl - 10       ; CF affected
         jb _09_    ; jump if below ; jump if CF = 1
